...
<body>
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h1">
        <a href="#2.7.1-hotfix">2.7.1 HOTFIX</a>
      </div>
      ...
      <div class="heading h1">
        <a href="#2.0.0-b3">2.0.0-b3</a>
      </div>

      <div class="heading h1">
        <a href="#2.0.0-b2">2.0.0-b2</a>
      </div>

      <div class="heading h1">
        <a href="#2.0.0-b1">2.0.0-b1</a>
      </div>
      ...
      <div class="heading h1">
        <a href="#1.6.3">1.6.3</a>
      </div>

      <div class="heading h1">
        <a href="#1.6.2">1.6.2</a>
      </div>
      ...
      <div class="heading h1">
        <a href="#1.4.0-beta-4">1.4.0 Beta 4</a>
      </div>

      <div class="heading h1">
        <a href="#1.4.0-beta-3">1.4.0 Beta 3</a>
      </div>

      <div class="heading h1">
        <a href="#1.4.0-beta-1-and-2">1.4.0 Beta 1 &amp;amp; 2</a>
      </div>
  ...
  <div id="container">
    <div class="docs markdown"><div class="pilwrap" id="2.7.2">
  <h1>
...
<p>2017-01-04</p>
<ul>
<li>Revert changes to contrast() function in 2.7.0</li>
</ul>
<div class="pilwrap" id="2.7.1-hotfix">
  <h1>
    <a href="#2.7.1-hotfix" name="2.7.1-hotfix" class="pilcrow"></a>
2.7.1 HOTFIX
  </h1>
</div>
<p>2016-05-09</p>
<ul>
<li>Revert commit 470af20 (source map performance) which broke source maps</li>
</ul>
...
<p>2016-05-07</p>
<ul>
<li>Fixes for contrast() function</li>
<li>Allow root functions for plugins</li>
<li>Allow semi-colon separators in functions</li>
<li>Performance improvements for source maps</li>
<li>Fix &quot;blank page&quot; issue in browser</li>
<li>Compatibility fixes for Node 6.x</li>
<li>Fix AST to include single-line comments</li>
<li>Fix reversion for &quot;color-like&quot; words (outputting color values)</li>
</ul>
...
<p>2016-03-04</p>
<ul>
<li>Update Less.js dependencies</li>
<li>Fix comments after named color regression</li>
<li>use instanceof operator instead of class comparison optimization</li>
<li>disallow whitespace in variable calls</li>
</ul>
...
<p>2016-01-29</p>
<ul>
<li>Underscore now allowed in dimension unit</li>
<li>Fixes for import by reference</li>
<li>Fix for #2384 Changes HTTPRequest &quot;sync&quot; setting to simply hide the page until less has rendered, browser version is now orders of magnitude faster.</li>
<li>Added ability to cache stylesheets while using modifyVars</li>
<li>Error when when image-size functions are used in browser-less</li>
<li>Fixed extend leaking through nested parent selector. #2586</li>
<li>Added &quot;or&quot; keyword and allowed arbitrary logical expression in guards</li>
<li>Fixing #2124 - Parsing Error &quot;Unrecognised input&quot; for color operations</li>
<li>Logical operator <code>and</code> now has higher precedence than logical operator <code>or</code>.</li>
<li>Allow unknown at-rules w/o {} block</li>
</ul>
...
<p>2015-09-24</p>
<ul>
<li>No output should result in an empty sourcemap</li>
<li>Import inline located inside file imported by reference should not be present in output</li>
<li>Shorthand colors will stay shorthand</li>
<li>Make percentage work like other math functions and throw an error on NaN</li>
<li>Fixed mixin definition matching problem when mixin definition contains parameters with default values</li>
<li>Observe reference for imported comments</li>
</ul>
...
<p>2015-05-21</p>
<ul>
<li>Fix problems with less being async in some browsers</li>
<li>Minor fix only likely to affect programmatic usage of ruleset find</li>
<li>Fix  error when a namespaced mixin is invoked in global scope</li>
</ul>
...
<p>2015-04-03</p>
<ul>
<li>supports the scoped <code>@plugin</code> directive to load function plugins</li>
...
<li><code>@import (css)</code> does not pull the directive above comments</li>
...
<li>Extends on a selector joined with <code>&amp;</code> now work better</li>
...
<li>Files with just <code>\r</code> newlines now process ok (regression in 2.0.0)</li>
...
<li>Support parent selector (<code>&amp;</code>) used in sub element expression (e.g. <code>:not(.c_&amp;)</code>)</li>
</ul>
...
<p>2015-01-27</p>
<ul>
<li>add <code>isruleset</code> function</li>
<li>add optional import option, causing less to not fail if file not found</li>
<li>Fix browsers-side cache.</li>
<li>Many fixes to import reference - support <code>@support</code> and keyframe</li>
<li>Selectors now interpolate pseudo selectors (e.g. <code>:@{hover}</code>)</li>
...
<li><code>isunit</code> function supports <code>''</code> to test if a dimension has no unit</li>
...
<li>detection of whether a file is css now requires <code>/css</code>, <code>.css</code>, <code>?css</code>, <code>&amp;css</code> instead of just <code>css</code>. You can still tell less the type of file using import options.</li>
...
<li>Added <code>getCSSAppendage</code> to sourcemap builder to avoid duplication in plugins</li>
<li>Fix problem with plugins when used with the promises version of render</li>
<li>If the render callback throws an exception it now propagates instead of calling the callback again with an error</li>
</ul>
...
<p>2014-11-23</p>
<ul>
<li>Fixed <code>isSync</code> option, it was using sync file operations but promises are guaranteed to call back async. We now support promises as a feature rather than the 1st class way of doing things.</li>
...
<li>support for <code>@counter-style</code> directive</li>
</ul>
<div class="pilwrap" id="2.0.0-b3">
  <h1>
    <a href="#2.0.0-b3" name="2.0.0-b3" class="pilcrow"></a>
2.0.0-b3
  </h1>
</div>
<p>2014-11-01</p>
...
<li>browser <code>useFileCache</code> defaults to <code>true</code>, but file cache is now cleared when refreshing or in watch mode</li>
</ul>
<div class="pilwrap" id="2.0.0-b2">
  <h1>
    <a href="#2.0.0-b2" name="2.0.0-b2" class="pilcrow"></a>
2.0.0-b2
  </h1>
</div>
<p>2014-10-26</p>
...
<li>Browser can now accept options as attributes on the script tag and the link tags e.g. <code>&lt;script data-verbose=&quot;false&quot; src=&quot;less.js&quot;...</code></li>
...
<li>Fixed a bug where unquoted urls beginning <code>//</code> e.g. <code>url(//file/file.less)</code> would be incorrectly interpreted (bug introduced in b-1)</li>
...
<div class="pilwrap" id="2.0.0-b1">
  <h1>
    <a href="#2.0.0-b1" name="2.0.0-b1" class="pilcrow"></a>
2.0.0-b1
  </h1>
</div>
<p>2014-10-19</p>
...
<li>Fix support for <code>.mixin(@args...)</code> when called with no args (e.g. <code>.mixin();</code>)</li>
<li>Do unit conversions with min and max functions. Don't pass through if not understood, throw an error</li>
<li>Allow % to be passed on its own to the unit function e.g. <code>unit(10, %)</code></li>
...
<div class="pilwrap" id="1.6.3">
  <h1>
    <a href="#1.6.3" name="1.6.3" class="pilcrow"></a>
1.6.3
  </h1>
</div>
<p>2014-02-08</p>
...
<div class="pilwrap" id="1.6.2">
  <h1>
    <a href="#1.6.2" name="1.6.2" class="pilcrow"></a>
1.6.2
  </h1>
</div>
<p>2014-02-02</p>
...
<li>Fold in <code>&amp; when () {</code> to the current selector rather than duplicating it</li>
...
<div class="pilwrap" id="1.6.1">
  <h1>
    <a href="#1.6.1" name="1.6.1" class="pilcrow"></a>
1.6.1
  </h1>
</div>
<p>2014-01-12</p>
...
<li>support for import inline option to include css that you do NOT want less to parse e.g. <code>@import (inline) &quot;file.css&quot;;</code></li>
...
<div class="pilwrap" id="1.4.2">
  <h1>
    <a href="#1.4.2" name="1.4.2" class="pilcrow"></a>
1.4.2
  </h1>
</div>
<p>2013-07-20</p>
...
<div class="pilwrap" id="1.4.1">
  <h1>
    <a href="#1.4.1" name="1.4.1" class="pilcrow"></a>
1.4.1
  </h1>
</div>
<p>2013-07-05</p>
...
<div class="pilwrap" id="1.4.0-beta-4">
  <h1>
    <a href="#1.4.0-beta-4" name="1.4.0-beta-4" class="pilcrow"></a>
1.4.0 Beta 4
  </h1>
</div>
<p>2013-05-04</p>
...
<div class="pilwrap" id="1.4.0-beta-3">
  <h1>
    <a href="#1.4.0-beta-3" name="1.4.0-beta-3" class="pilcrow"></a>
1.4.0 Beta 3
  </h1>
</div>
<p>2013-04-30</p>
...
<div class="pilwrap" id="1.4.0-beta-1-and-2">
  <h1>
    <a href="#1.4.0-beta-1-and-2" name="1.4.0-beta-1-and-2" class="pilcrow"></a>
1.4.0 Beta 1 &amp; 2
  </h1>
</div>
<p>2013-03-07</p>
<ul>
<li>support for <code>:extend()</code> in selectors (e.g. <code>input:extend(.button) {}</code>) and <code>&amp;:extend();</code> in ruleset (e.g. <code>input { &amp;:extend(.button all); }</code>)</li>
...
<li><code>(~&quot;@var&quot;)</code> selector interpolation is removed. Use @{var} in selectors to have variable selectors</li>
<li>default behaviour of import is to import each file once. <code>@import-once</code> has been removed.</li>
<li>You can specify options on imports to force it to behave as css or less <code>@import (less) &quot;file.css&quot;</code> will process the file as less</li>
...
<li>lessc <code>@import</code> supports https and 301's</li>
...
<li>when using the filter contrast function, the function is passed through if the first argument is not a color</li>
</ul>
...
<li>Support mixin argument separator of ';' so you can pass comma separated values. e.g. <code>.mixin(23px, 12px;);</code></li>
...
<li>fix <code>@import-once</code> to use the full path, not the relative one for determining if an import has been imported already</li>
<li>support <code>:not(:nth-child(3))</code></li>
<li>mixin guards take units into account</li>
<li>support unicode descriptors (<code>U+00A1-00A9</code>)</li>
<li>support calling mixins with a stack when using <code>&amp;</code> (broken in 1.3.1)</li>
<li>support <code>@namespace</code> and namespace combinators</li>
...
<li>ignore subsequant <code>@charset</code></li>
...
<li>Allow <code>@import</code> directives in any selector</li>
...
<li>Fix an <code>@arguments</code> behaviour bug</li>
<li>Fix <code>::</code> selector output</li>
...
<li>Fix <code>File not found</code> import error reporting</li>
</ul>
...
<ul>
<li>Mixin guards</li>
<li>New function <code>percentage</code></li>
<li>New <code>color</code> function to parse hex color strings</li>
...
<li>Support <code>!important</code> after mixin calls</li>
<li>Support vanilla @keyframes directive</li>
<li>Support variables in certain css selectors, like <code>nth-child</code></li>
