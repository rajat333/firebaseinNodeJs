  ...
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h1">
        <a href="#extract-options-and-callback">Extract Options &amp; Callback</a>
      </div>
...
<div class="pilwrap" id="extract-options-and-callback">
  <h1>
    <a href="#extract-options-and-callback" name="extract-options-and-callback" class="pilcrow"></a>
Extract Options & Callback
  </h1>
</div>
<!-- /TITLE -->
<!-- BADGES/ -->
<p><span class="badge-travisci"><a href="http://travis-ci.org/bevry/extract-opts" title="Check this project's build status on TravisCI"><img src="https://img.shields.io/travis/bevry/extract-opts/master.svg" alt="Travis CI Build Status" /></a></span>
...
<!-- /BADGES -->
<!-- DESCRIPTION/ -->
<p>Extract the options and callback from a function's arguments easily</p>
<!-- /DESCRIPTION -->
<!-- INSTALL/ -->
...
<pre><code class="javascript"><span class="hljs-keyword">var</span> log = <span class="hljs-built_in">console</span>.log.bind(<span class="hljs-built_in">console</span>)
<span class="hljs-keyword">var</span> extractOptsAndCallback = <span class="hljs-built_in">require</span>(<span class="hljs-string">'extract-opts'</span>)

<span class="hljs-comment">// fs.readFile(filename, [options], callback)</span>
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">readFile</span> (<span class="hljs-params">filename, opts, next</span>) </span>{
	<span class="hljs-comment">// Extract options and callback</span>
	<span class="hljs-keyword">var</span> args = extractOptsAndCallback(opts, next)
	opts = args[<span class="hljs-number">0</span>]
	next = args[<span class="hljs-number">1</span>]

	<span class="hljs-comment">// Forward for simplicities sake</span>
	<span class="hljs-built_in">require</span>(<span class="hljs-string">'fs'</span>).readFile(filename, opts, next)
}

<span class="hljs-comment">// Test it</span>
readFile(<span class="hljs-string">'package.json'</span>, log)          <span class="hljs-comment">// works with no options</span>
readFile(<span class="hljs-string">'package.json'</span>, <span class="hljs-literal">null</span>, log)    <span class="hljs-comment">// works with null options</span>
readFile(<span class="hljs-string">'package.json'</span>, {<span class="hljs-attr">next</span>: log})   <span class="hljs-comment">// works with just options</span>
</code></pre>
<div class="pilwrap" id="customisation">
  <h3>
    <a href="#customisation" name="customisation" class="pilcrow"></a>
Customisation
  </h3>
</div>
<p>Extract Options and Callback also supports a third argument.
You can use this third argument to customize the <code>completionCallbackNames</code> property that defaults to <code>['next']</code>.
This is useful if your completion callback has other names besides <code>next</code>.
Allowing you to do the following:</p>
...
<p><a href="https://github.com/bevry/extract-opts/blob/master/HISTORY.md#files">Discover the release history by heading on over to the <code>HISTORY.md</code> file.</a></p>
<!-- /HISTORY -->
<!-- CONTRIBUTE/ -->
...
<p><a href="https://github.com/bevry/extract-opts/blob/master/CONTRIBUTING.md#files">Discover how you can contribute by heading on over to the <code>CONTRIBUTING.md</code> file.</a></p>
<!-- /CONTRIBUTE -->
<!-- BACKERS/ -->
