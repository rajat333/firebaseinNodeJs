...
<head>
  ...
  <script>
    var relativeDir = "../../../";
    var thisFile = "node-refresh-token\\node_modules\\source-map-resolve\\readme.md";
  ...
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h3">
        <a href="#sourcemapresolve.resolvesourcemap-code-codeurl-read-callback">sourceMapResolve.resolveSourceMap(code, codeUrl, read, callback)</a>
      </div>

      <div class="heading h3">
        <a href="#sourcemapresolve.resolvesources-map-mapurl-read-options-callback">sourceMapResolve.resolveSources(map, mapUrl, read, [options], callback)</a>
      </div>

      <div class="heading h3">
        <a href="#sourcemapresolve.resolve-code-codeurl-read-options-callback">sourceMapResolve.resolve(code, codeUrl, read, [options], callback)</a>
      </div>

      <div class="heading h3">
        <a href="#sourcemapresolve.*sync">sourceMapResolve.*Sync()</a>
      </div>

      <div class="heading h3">
        <a href="#sourcemapresolve.parsemaptojson-string-data">sourceMapResolve.parseMapToJSON(string, [data])</a>
      </div>
      ...
      <div class="heading h2">
        <a href="#x-package.json5">x-package.json5</a>
      </div>

      <div class="heading h2">
        <a href="#generating-the-browser-version">Generating the browser version</a>
      </div>
...
Overview <a href="https://travis-ci.org/lydell/source-map-resolve"><img src="https://travis-ci.org/lydell/source-map-resolve.svg?branch=master" alt="Build Status"></a>
  </h1>
</div>
<p>Resolve the source map and/or sources for a generated file.</p>
<pre><code class="js"><span class="hljs-keyword">var</span> sourceMapResolve = <span class="hljs-built_in">require</span>(<span class="hljs-string">"source-map-resolve"</span>)
...
<div class="pilwrap" id="sourcemapresolve.resolvesourcemap-code-codeurl-read-callback">
  <h3>
    <a href="#sourcemapresolve.resolvesourcemap-code-codeurl-read-callback" name="sourcemapresolve.resolvesourcemap-code-codeurl-read-callback" class="pilcrow"></a>
<code>sourceMapResolve.resolveSourceMap(code, codeUrl, read, callback)</code>
  </h3>
</div>
<ul>
...
<div class="pilwrap" id="sourcemapresolve.resolvesources-map-mapurl-read-options-callback">
  <h3>
    <a href="#sourcemapresolve.resolvesources-map-mapurl-read-options-callback" name="sourcemapresolve.resolvesources-map-mapurl-read-options-callback" class="pilcrow"></a>
<code>sourceMapResolve.resolveSources(map, mapUrl, read, [options], callback)</code>
  </h3>
</div>
<ul>
...
<div class="pilwrap" id="sourcemapresolve.resolve-code-codeurl-read-options-callback">
  <h3>
    <a href="#sourcemapresolve.resolve-code-codeurl-read-options-callback" name="sourcemapresolve.resolve-code-codeurl-read-options-callback" class="pilcrow"></a>
<code>sourceMapResolve.resolve(code, codeUrl, read, [options], callback)</code>
  </h3>
</div>
...
header (see the <a href="#notes.html">Notes</a> section). In this case, the <code>sourceMappingURL</code> property
of the result is <code>null</code>.</p>
<div class="pilwrap" id="sourcemapresolve.*sync">
  <h3>
    <a href="#sourcemapresolve.*sync" name="sourcemapresolve.*sync" class="pilcrow"></a>
<code>sourceMapResolve.*Sync()</code>
  </h3>
</div>
...
<div class="pilwrap" id="sourcemapresolve.parsemaptojson-string-data">
  <h3>
    <a href="#sourcemapresolve.parsemaptojson-string-data" name="sourcemapresolve.parsemaptojson-string-data" class="pilcrow"></a>
<code>sourceMapResolve.parseMapToJSON(string, [data])</code>
  </h3>
</div>
...
<div class="pilwrap" id="x-package.json5">
  <h2>
    <a href="#x-package.json5" name="x-package.json5" class="pilcrow"></a>
x-package.json5
  </h2>
</div>
...
<div class="pilwrap" id="generating-the-browser-version">
  <h2>
    <a href="#generating-the-browser-version" name="generating-the-browser-version" class="pilcrow"></a>
...
<p><a href="LICENSE.html">The X11 (“MIT”) License</a>.</p>
</div>
  </div>
</body>
</html>
