...
<p>Copyright 2014, 2015, 2016, 2017 Simon Lydell
...
<span class="hljs-keyword">void</span> (<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">root, factory</span>) </span>{
  ...
  <span class="hljs-keyword">var</span> jsonMimeTypeRegex = <span class="hljs-regexp">/^(?:application|text)\/json$/</span>
  ...
  <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">resolveSourceMapHelper</span>(<span class="hljs-params">code, codeUrl</span>) </span>{
    ...
    <span class="hljs-keyword">if</span> (dataUri) {
      <span class="hljs-keyword">var</span> mimeType = dataUri[<span class="hljs-number">1</span>]
      ...
      <span class="hljs-keyword">if</span> (!jsonMimeTypeRegex.test(mimeType)) {
        <span class="hljs-keyword">var</span> error = <span class="hljs-keyword">new</span> <span class="hljs-built_in">Error</span>(<span class="hljs-string">"Unuseful data uri mime type: "</span> + (mimeType || <span class="hljs-string">"text/plain"</span>))
        error.sourceMapData = data
        <span class="hljs-keyword">throw</span> error
      }
      data.map = parseMapToJSON(
        lastParameter === <span class="hljs-string">";base64"</span> ? atob(encoded) : <span class="hljs-built_in">decodeURIComponent</span>(encoded),
        data
      )
