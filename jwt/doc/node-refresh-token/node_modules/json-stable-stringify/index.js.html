...
<table cellpadding="0" cellspacing="0">
  ...
  <a class="pilcrow" href="#section-1" id="section-1"></a>
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-keyword">var</span> json = <span class="hljs-keyword">typeof</span> <span class="hljs-built_in">JSON</span> !== <span class="hljs-string">'undefined'</span> ? <span class="hljs-built_in">JSON</span> : <span class="hljs-built_in">require</span>(<span class="hljs-string">'jsonify'</span>);
