...
<table cellpadding="0" cellspacing="0">
  ...
  <a class="pilcrow" href="#section-1" id="section-1"></a>
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-keyword">var</span> fs = <span class="hljs-built_in">require</span>(<span class="hljs-string">'./fs.js'</span>)
...
<p>if read() returns EAGAIN, then just try it again.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  fs.read = (<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">fs$read</span>) </span>{ <span class="hljs-keyword">return</span> <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">fd, buffer, offset, length, position, callback_</span>) </span>{
...
uid + gid.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">return</span> <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">target, cb</span>) </span>{
    <span class="hljs-keyword">return</span> orig.call(fs, target, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">er, stats</span>) </span>{
      <span class="hljs-keyword">if</span> (!stats) <span class="hljs-keyword">return</span> cb.apply(<span class="hljs-keyword">this</span>, <span class="hljs-built_in">arguments</span>)
...
uid + gid.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">return</span> <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">target</span>) </span>{
    <span class="hljs-keyword">var</span> stats = orig.call(fs, target)
    <span class="hljs-keyword">if</span> (stats.uid &lt; <span class="hljs-number">0</span>) stats.uid += <span class="hljs-number">0x100000000</span>
    <span class="hljs-keyword">if</span> (stats.gid &lt; <span class="hljs-number">0</span>) stats.gid += <span class="hljs-number">0x100000000</span>
