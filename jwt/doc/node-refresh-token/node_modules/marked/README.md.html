...
<body>
  ...
  <div id="container">
    <div class="docs markdown"><div class="pilwrap" id="marked">
  <h1>
    <a href="#marked" name="marked" class="pilcrow"></a>
Marked
  </h1>
</div>
<p>Marked is</p>
...
<li>a low-level markdown compiler that allows frequent parsing of large chunks of markdown without caching or blocking for long periods of time.</li>
<li>light-weight while implementing all markdown features from the supported flavors &amp; specifications.</li>
...
<p><strong>In-browser:</strong> <code>npm install marked --save</code></p>
...
<span class="hljs-tag">&lt;<span class="hljs-name">head</span>&gt;</span>
  ...
  <span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"https://cdn.jsdelivr.net/npm/marked/marked.min.js"</span>&gt;</span><span class="undefined"></span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">head</span>&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">body</span>&gt;</span>
  ...
  <span class="hljs-tag">&lt;<span class="hljs-name">script</span>&gt;</span><span class="javascript">
    <span class="hljs-built_in">document</span>.getElementById(<span class="hljs-string">'content'</span>).innerHTML =
      marked(<span class="hljs-string">'# Marked in the browser\n\nRendered by **marked**.'</span>);
...
<p>Copyright (c) 2011-2018, Christopher Jeffrey. (MIT License)</p>
</div>
  </div>
</body>
</html>
