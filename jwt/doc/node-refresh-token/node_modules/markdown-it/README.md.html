...
<body>
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h1">
        <a href="#markdown-it">markdown-it</a>
      </div>
      ...
      <div class="heading h3">
        <a href="#init-with-presets-and-options">Init with presets and options</a>
      </div>

      <div class="heading h3">
        <a href="#plugins-load">Plugins load</a>
      </div>
      ...
      <div class="heading h3">
        <a href="#manage-rules">Manage rules</a>
      </div>
      ...
      <div class="heading h2">
        <a href="#references-thanks">References / Thanks</a>
      </div>
  ...
  <div id="container">
    <div class="docs markdown"><div class="pilwrap" id="markdown-it">
  <h1>
    <a href="#markdown-it" name="markdown-it" class="pilcrow"></a>
markdown-it
  </h1>
</div>
...
<li><a href="#syntax-extensions.html">Syntax extensions</a></li>
<li><a href="#benchmark.html">Benchmark</a></li>
<li><a href="#authors.html">Authors</a></li>
<li><a href="#references--thanks.html">References / Thanks</a></li>
...
<pre><code class="bash">npm install markdown-it --save
...
<div class="pilwrap" id="simple">
  <h3>
    <a href="#simple" name="simple" class="pilcrow"></a>
Simple
  </h3>
</div>
<pre><code class="js"><span class="hljs-comment">// node.js, "classic" way:</span>
...
<pre><code class="js"><span class="hljs-keyword">var</span> md = <span class="hljs-built_in">require</span>(<span class="hljs-string">'markdown-it'</span>)();
<span class="hljs-keyword">var</span> result = md.renderInline(<span class="hljs-string">'__markdown-it__ rulezz!'</span>);
</code></pre>
<div class="pilwrap" id="init-with-presets-and-options">
  <h3>
    <a href="#init-with-presets-and-options" name="init-with-presets-and-options" class="pilcrow"></a>
...
<pre><code class="js"><span class="hljs-comment">// commonmark mode</span>
...
<span class="hljs-keyword">var</span> md = <span class="hljs-built_in">require</span>(<span class="hljs-string">'markdown-it'</span>)({
  ...
  <span class="hljs-comment">// or '' if the source string is not changed and should be escaped externaly.</span>
...
<div class="pilwrap" id="plugins-load">
  <h3>
    <a href="#plugins-load" name="plugins-load" class="pilcrow"></a>
Plugins load
  </h3>
</div>
<pre><code class="js"><span class="hljs-keyword">var</span> md = <span class="hljs-built_in">require</span>(<span class="hljs-string">'markdown-it'</span>)()
...
<div class="pilwrap" id="syntax-highlighting">
  <h3>
    <a href="#syntax-highlighting" name="syntax-highlighting" class="pilcrow"></a>
Syntax highlighting
  </h3>
</div>
<p>Apply syntax highlighting to fenced code blocks with the <code>highlight</code> option:</p>
<pre><code class="js"><span class="hljs-keyword">var</span> hljs = <span class="hljs-built_in">require</span>(<span class="hljs-string">'highlight.js'</span>); <span class="hljs-comment">// https://highlightjs.org/</span>
...
<div class="pilwrap" id="linkify">
  <h3>
    <a href="#linkify" name="linkify" class="pilcrow"></a>
Linkify
  </h3>
</div>
...
<pre><code class="js">md.linkify.tlds(<span class="hljs-string">'.py'</span>, <span class="hljs-literal">false</span>);  <span class="hljs-comment">// disables .py as top level domain</span>
</code></pre>
...
<div class="pilwrap" id="syntax-extensions">
  <h2>
    <a href="#syntax-extensions" name="syntax-extensions" class="pilcrow"></a>
Syntax extensions
  </h2>
</div>
...
<li><a href="https://help.github.com/articles/github-flavored-markdown/#strikethrough">Strikethrough</a> (GFM)</li>
</ul>
<p>Via plugins:</p>
<ul>
...
<div class="pilwrap" id="manage-rules">
  <h3>
    <a href="#manage-rules" name="manage-rules" class="pilcrow"></a>
Manage rules
  </h3>
</div>
...
<pre><code class="js"><span class="hljs-comment">// Activate/deactivate rules, with curring</span>
<span class="hljs-keyword">var</span> md = <span class="hljs-built_in">require</span>(<span class="hljs-string">'markdown-it'</span>)()
...
<pre><code class="bash">$ benchmark/benchmark.js readme
...
<div class="pilwrap" id="references-thanks">
  <h2>
    <a href="#references-thanks" name="references-thanks" class="pilcrow"></a>
References / Thanks
  </h2>
</div>
...
<p><a href="https://github.com/markdown-it/markdown-it/blob/master/LICENSE">MIT</a></p>
</div>
  </div>
</body>
</html>
