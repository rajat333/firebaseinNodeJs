...
<body>
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h1">
        <a href="#sprintf.js">sprintf.js</a>
      </div>

      <div class="heading h2">
        <a href="#javascript-vsprintf">JavaScript vsprintf</a>
      </div>

      <div class="heading h2">
        <a href="#argument-swapping">Argument swapping</a>
      </div>
      ...
      <div class="heading h2">
        <a href="#via-bower">Via Bower</a>
      </div>

      <div class="heading h2">
        <a href="#or-as-a-node.js-module">Or as a node.js module</a>
      </div>
  ...
  <div id="container">
    <div class="docs markdown"><div class="pilwrap" id="sprintf.js">
  <h1>
    <a href="#sprintf.js" name="sprintf.js" class="pilcrow"></a>
sprintf.js
  </h1>
</div>
...
<div class="pilwrap" id="javascript-vsprintf">
  <h2>
    <a href="#javascript-vsprintf" name="javascript-vsprintf" class="pilcrow"></a>
JavaScript <code>vsprintf</code>
  </h2>
</div>
...
<div class="pilwrap" id="argument-swapping">
  <h2>
    <a href="#argument-swapping" name="argument-swapping" class="pilcrow"></a>
Argument swapping
  </h2>
</div>
...
<div class="pilwrap" id="named-arguments">
  <h2>
    <a href="#named-arguments" name="named-arguments" class="pilcrow"></a>
Named arguments
  </h2>
</div>
...
<div class="pilwrap" id="computed-values">
  <h2>
    <a href="#computed-values" name="computed-values" class="pilcrow"></a>
Computed values
  </h2>
</div>
...
<div class="pilwrap" id="angularjs">
  <h1>
    <a href="#angularjs" name="angularjs" class="pilcrow"></a>
AngularJS
  </h1>
</div>
...
<div class="pilwrap" id="via-bower">
  <h2>
    <a href="#via-bower" name="via-bower" class="pilcrow"></a>
Via Bower
  </h2>
</div>
<pre><code>bower install sprintf
</code></pre>
<div class="pilwrap" id="or-as-a-node.js-module">
  <h2>
    <a href="#or-as-a-node.js-module" name="or-as-a-node.js-module" class="pilcrow"></a>
