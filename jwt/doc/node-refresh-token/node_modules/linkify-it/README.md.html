...
<body>
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h1">
        <a href="#linkify-it">linkify-it</a>
      </div>
      ...
      <div class="heading h5">
        <a href="#example-2.add-twitter-mentions-handler">Example 2. Add twitter mentions handler</a>
      </div>
      ...
      <div class="heading h3">
        <a href="#new-linkifyit-schemas-options">new LinkifyIt(schemas, options)</a>
      </div>
      ...
      <div class="heading h3">
        <a href="#.pretest-text">.pretest(text)</a>
      </div>

      <div class="heading h3">
        <a href="#.testschemaat-text-name-offset">.testSchemaAt(text, name, offset)</a>
      </div>

      <div class="heading h3">
        <a href="#.match-text">.match(text)</a>
      </div>

      <div class="heading h3">
        <a href="#.tlds-list-keepold">.tlds(list[, keepOld])</a>
      </div>

      <div class="heading h3">
        <a href="#.add-schema-definition">.add(schema, definition)</a>
      </div>

      <div class="heading h3">
        <a href="#.set-options">.set(options)</a>
      </div>
  ...
  <div id="container">
    <div class="docs markdown"><div class="pilwrap" id="linkify-it">
  <h1>
    <a href="#linkify-it" name="linkify-it" class="pilcrow"></a>
linkify-it
  </h1>
</div>
...
<pre><code class="bash">npm install linkify-it --save
</code></pre>
...
<pre><code class="js"><span class="hljs-keyword">var</span> linkify = <span class="hljs-built_in">require</span>(<span class="hljs-string">'linkify-it'</span>)();

<span class="hljs-comment">// Reload full tlds list &amp; add unofficial `.onion` domain.</span>
linkify
  .tlds(<span class="hljs-built_in">require</span>(<span class="hljs-string">'tlds'</span>))          <span class="hljs-comment">// Reload with full tlds list</span>
  .tlds(<span class="hljs-string">'onion'</span>, <span class="hljs-literal">true</span>)            <span class="hljs-comment">// Add unofficial `.onion` domain</span>
  .linkify.add(<span class="hljs-string">'git:'</span>, <span class="hljs-string">'http:'</span>)   <span class="hljs-comment">// Add `git:` ptotocol as "alias"</span>
  .linkify.add(<span class="hljs-string">'ftp:'</span>, <span class="hljs-literal">null</span>)      <span class="hljs-comment">// Disable `ftp:` ptotocol</span>
  .set({ <span class="hljs-attr">fuzzyIP</span>: <span class="hljs-literal">true</span> });        <span class="hljs-comment">// Enable IPs in fuzzy links (without schema)</span>

<span class="hljs-built_in">console</span>.log(linkify.test(<span class="hljs-string">'Site github.com!'</span>));  <span class="hljs-comment">// true</span>

<span class="hljs-built_in">console</span>.log(linkify.match(<span class="hljs-string">'Site github.com!'</span>)); <span class="hljs-comment">// [ {</span>
                                                <span class="hljs-comment">//   schema: "",</span>
                                                <span class="hljs-comment">//   index: 5,</span>
                                                <span class="hljs-comment">//   lastIndex: 15,</span>
                                                <span class="hljs-comment">//   raw: "github.com",</span>
                                                <span class="hljs-comment">//   text: "github.com",</span>
                                                <span class="hljs-comment">//   url: "http://github.com",</span>
                                                <span class="hljs-comment">// } ]</span>
</code></pre>
<div class="pilwrap" id="example-2.add-twitter-mentions-handler">
  <h5>
    <a href="#example-2.add-twitter-mentions-handler" name="example-2.add-twitter-mentions-handler" class="pilcrow"></a>
Example 2. Add twitter mentions handler
  </h5>
</div>
<pre><code class="js">linkify.add(<span class="hljs-string">'@'</span>, {
  <span class="hljs-attr">validate</span>: <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">text, pos, self</span>) </span>{
    ...
    <span class="hljs-keyword">if</span> (!self.re.twitter) {
      self.re.twitter =  <span class="hljs-keyword">new</span> <span class="hljs-built_in">RegExp</span>(
        <span class="hljs-string">'^([a-zA-Z0-9_]){1,15}(?!_)(?=$|'</span> + self.re.src_ZPCc + <span class="hljs-string">')'</span>
      );
    }
    <span class="hljs-keyword">if</span> (self.re.twitter.test(tail)) {
      <span class="hljs-comment">// Linkifier allows punctuation chars before prefix,</span>
      <span class="hljs-comment">// but we additionally disable `@` ("@@mention" is invalid)</span>
      <span class="hljs-keyword">if</span> (pos &gt;= <span class="hljs-number">2</span> &amp;&amp; tail[pos - <span class="hljs-number">2</span>] === <span class="hljs-string">'@'</span>) {
        <span class="hljs-keyword">return</span> <span class="hljs-literal">false</span>;
      }
      <span class="hljs-keyword">return</span> tail.match(self.re.twitter)[<span class="hljs-number">0</span>].length;
    }
    <span class="hljs-keyword">return</span> <span class="hljs-number">0</span>;
  },
  <span class="hljs-attr">normalize</span>: <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">match</span>) </span>{
    match.url = <span class="hljs-string">'https://twitter.com/'</span> + match.url.replace(<span class="hljs-regexp">/^@/</span>, <span class="hljs-string">''</span>);
  }
});
</code></pre>
...
<div class="pilwrap" id="new-linkifyit-schemas-options">
  <h3>
    <a href="#new-linkifyit-schemas-options" name="new-linkifyit-schemas-options" class="pilcrow"></a>
...
<div class="pilwrap" id=".test-text">
  <h3>
    <a href="#.test-text" name=".test-text" class="pilcrow"></a>
.test(text)
  </h3>
</div>
<p>Searches linkifiable pattern and returns <code>true</code> on success or <code>false</code> on fail.</p>
<div class="pilwrap" id=".pretest-text">
  <h3>
    <a href="#.pretest-text" name=".pretest-text" class="pilcrow"></a>
.pretest(text)
  </h3>
</div>
...
<div class="pilwrap" id=".testschemaat-text-name-offset">
  <h3>
    <a href="#.testschemaat-text-name-offset" name=".testschemaat-text-name-offset" class="pilcrow"></a>
...
<div class="pilwrap" id=".match-text">
  <h3>
    <a href="#.match-text" name=".match-text" class="pilcrow"></a>
.match(text)
  </h3>
</div>
...
<div class="pilwrap" id=".tlds-list-keepold">
  <h3>
    <a href="#.tlds-list-keepold" name=".tlds-list-keepold" class="pilcrow"></a>
.tlds(list[, keepOld])
  </h3>
</div>
...
<div class="pilwrap" id=".add-schema-definition">
  <h3>
    <a href="#.add-schema-definition" name=".add-schema-definition" class="pilcrow"></a>
...
<div class="pilwrap" id=".set-options">
  <h3>
    <a href="#.set-options" name=".set-options" class="pilcrow"></a>
.set(options)
  </h3>
</div>
